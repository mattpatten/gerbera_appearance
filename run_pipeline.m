...
%   (vii) Allow manual corrections to segmented flowers and save images that display the segmentation values.
...
addpath([fileparts(mfilename('fullpath')) filesep 'img_properties' filesep]);        %look for sub-directory from current m-file called 'img_properties'. Don't add any of its sub-directories
